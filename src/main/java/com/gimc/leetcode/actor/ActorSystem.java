...
public class ActorSystem {
    ...
    public ActorSystem(String name, int threads, boolean fair) {
        ...
        BlockingQueue<Runnable> queue = fair ? new PriorityBlockingQueue<Runnable>() : new LinkedBlockingQueue<Runnable>();
    ...
    private <E> Actor<E> createOrGet(String actorPath, Processor<E> processor) {
        ...
        if (old == null) {
            System.out.println("create actorSystem: {}" + actorPath);
    ...
    public static class Actor<E> implements Runnable, Comparable<Actor> {
        ...
        public boolean equals(Object o) {
            ...
            Actor<?> actor = (Actor<?>) o;
            return Objects.equals(systemName, actor.systemName) && Objects.equals(name, actor.name);
        }
        ...
        public final boolean add(final T value) {
            for (Node<T> n = null; ; ) {
                ...
                if (lastNodeCount - getDeq().count < capacity) {
                    ...
                    return false; // Over capacity—couldn't add the node
                }
            }
        }
        ...
        public final Node<T> pollNode() {
            for (; ; ) {
                ...
                if (next != null) {
                    ...
                    return null; // If we got a null and head meets tail, we are empty
                }
            }
        }
